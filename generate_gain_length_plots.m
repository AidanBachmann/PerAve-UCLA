...
detuneArr = (1:Nc_steps)*0; % Array to store final detuning parameter
t1 = tic;
for jdx = 1:Nc_steps
    ...
    detuneArr(jdx) = detune(end); % Save final detuning
...
% Comparison of theoretical and numerical gain lengths
figure(27);
subplot(1,2,1);
...
figure(28);
plot(currArr./1000,detuneArr,color='g'); % Detuning as a function of current
xlabel('Current (kA)');
ylabel('Detuning Parameter at End of Undulator');
title('Final Detuning as a Function of Current');